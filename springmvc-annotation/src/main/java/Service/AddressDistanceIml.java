...
import Dao.AddressDistanceDao;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import pojo.address_distance;
...
public class AddressDistanceIml implements AddressDistanceService{
    ...
    public int addAddressDistance(address_distance address_distance) {
        pojo.address_distance addressDistance = new address_distance(address_distance.getTo_address(),address_distance.getFrom_address(),address_distance.getDistance());
